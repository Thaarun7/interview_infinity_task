...
export const summaryStyleData = [
  {
    color: "text-c-blue",
    font: "fa-eye bg-c-blue",
    icon : "fas fa-eye"
  },
  {
    color: "text-c-green",
    font: "fa-bullseye bg-c-green",
    icon:"fas fa-bullseye"
  },
  {
    color: " text-c-yellow",
    font: " fa-hand-paper bg-c-yellow",
    icon: "fas fa-hand-paper "
  },
];

export  const  progressStyleData = [
  {
...
export  const whatsNewsStyle = [
  ...
  {
    element: <i className='feather icon-briefcase bg-c-red update-icon' />,
  },
  {
    element: (
